...
public class PAM {
    ...
    public static void Reglamento() {
        ...
        System.out.println("9. En circunstancia de indisciplina o falta de respeto por parte del alumno hacia docentes,administrativos, compañeros o cualquier persona perteneciente a la universidad, se realizaráuna primera llama de atención, si el alumno hace caso omiso tendrá que abandonar el aula, tres incidencias de este tipo el alumno no tendrá derecho a examen final o parcial.");
    ...
    System.out.println("EVIDENCIA DE CONOCIMIENTO 40% 40% 20% 1er Parcial 01-10-25");
    System.out.println("EVIDENCIA DE DESEMPEÑO    20% 20% 10%");
